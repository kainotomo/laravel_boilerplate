...
<div class="container">    
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('New Permission') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{route('administrator.permissions.save')}}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="guard_name" type="text" class="form-control @error('guard_name') is-invalid @enderror" name="guard_name" value="{{ old('guard_name') ?? 'web' }}" required autocomplete="guard_name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">                                     
                                <input class="form-check-input" type="checkbox" value="{{$role->name}}" name="role_{{$role->id}}" >
                            </div>
                        </div>
                        @endforeach
